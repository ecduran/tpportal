...
// this function will overide the error_reporting on php.ini
...
/**
* - Get/query the country code from the database.
*
* - @param string $country_code
*
* - @return object $country_id from xml response 
*/
...
/**
* - Get/query state id from the database.
*
* - @param string $state_code
*   @param string $country_code
*   @param object $country_id
*
* - @return object $state_id from xml response
*/
...
/**
* - Create/update affiliate address to the OpenERP databases.
*
* - @param object $partner_id
*   @param array $cddressVal
* 
*/
...
/**
* - Create/update affiliate to the OpenERP databases
*
* - @param array $vals this is user's information from signup form
*
* - @return invoke method create_update_address()
*/
