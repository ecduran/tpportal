...
if ($error)
    ...
    $affiliate->createAffiliate(); // insert user info to the affiliate table


    $affiliate->copyData(); // insert user info to affiliate.history table
    ...
    include_once 'openerp.php'; //UPDATE ALS20 OPENERP FIRST
